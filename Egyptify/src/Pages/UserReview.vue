    ...
    <div class="pt-20 container mx-auto px-4 max-w-6xl">
      <div class="grid grid-cols-12 gap-8">
        <div class="col-span-12 md:col-span-4">
          <h1 class="text-3xl font-bold text-black mb-6 leading-tight">
        ...
        < class="col-span-12 md:col-span-8 space-y-6">
          <div class="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div class="flex items-center gap-2 mb-2">
              <div
                ...
                :class="{
                  'bg-yellow-500 border-yellow-600': i <= (hoverRating || rating),
                  'border-gray-300': i > (hoverRating || rating),
                }"
              ></div>
          ...
          <!-- <div class="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div
              ...
              :class="{ 'text-red-500': reviewText.length < 100, 'text-gray-500': reviewText.length >= 100 }"
            >
          ...
          <div v-if="showTips" class="fixed inset-0 z-50 flex items-center justify-center">
            <div class="absolute inset-0 bg-black opacity-50" @click="showTips = false"></div>
            <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6 mx-4 border border-gray-200">
              <button @click="showTips = false" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700">
          ...
          <div class="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div
              class="text-right text-xs mt-1"
              :class="{ 'text-red-500': reviewTitle.length > 20, 'text-gray-500': reviewTitle.length <= 20 }"
            >
          ...
          <div class="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div
              class="border-2 border-dashed border-gray-300 rounded-md p-6 text-center cursor-pointer hover:bg-gray-50"
            >
          ...
          <div class="bg-white p-6 rounded-lg shadow-sm flex items-start">
            <input
              ...
              id="certify"
              v-model="certified"
              class="mt-1 mr-2 h-4 w-4 text-yellow-400 focus:ring-yellow-400 border-gray-300 rounded"
            />
          ...
          <BaseButton
            @click="submitReview"
            class="w-full bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 px-8 rounded-md transition-colors mb-10"
