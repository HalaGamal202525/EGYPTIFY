    ...
    <div class="max-w-3xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-xl">
          ...
          <div class="mb-4">
            ...
            >
              ...
              <template #suffix-icon>
                <i
                  class="fas fa-eye-slash absolute right-4 top-3 text-gray-400"
                />
              </template>
            </InputField>
          </div>
      ...
      <div v-else-if="activeTab === 'saved'">
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <div class="ml-4 flex-shrink-0">
              <img
                src="../../public/profile/Pyramids2.jpeg"
                alt="Cairo Adventure"
          ...
          <div class="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <div class="ml-4 flex-shrink-0">
              <img
                src="../../public/profile/Nile-River.jpg"
                alt="Nile Cruise"
                class="w-24 h-24 object-cover rounded-md"
              />
            </div>
        ...
        <div class="space-y-6 mt-8">
          ...
          <div class="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <div class="ml-4 flex-shrink-0">
              <img
                src="../../public/profile/Alex.jpg"
                alt="Alexandria Getaway"
                class="w-24 h-24 object-cover rounded-md"
              />
            </div>
          </div>
          <div class="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <div class="ml-4 flex-shrink-0">
              <img
                src="../../public/profile/luxor-vally of the kings.jpg"
                alt="Luxor Exploration"
                class="w-24 h-24 object-cover rounded-md"
              />
            </div>
          </div>
      ...
      <div v-else-if="activeTab === 'reviews'">
        ...
        <div class="space-y-6">
          <div class="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm">
            <div class="flex-grow">
              ...
              <p class="text-gray-700 text-sm">
                Amazing experience exploring the pyramids and the Sphinx. The
          ...
          <div class="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <div class="ml-4 flex-shrink-0">
              <img
                src="../../public/profile/Aswan-Abu-Simple-Tour.jpg"
                alt="Cairo Pyramids"
                class="w-24 h-24 object-cover rounded-md"
              />
            </div>
      ...
      <div v-else-if="activeTab === 'favorite'">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <div class="p-4">
              ...
              <p class="text-sm text-gray-600">
                Scenic Nile Cruises and Nubian Culture
              </p>
            </div>
          </div>
          <div
          ...
          >
            <img
              src="../../public/profile/Desert-Oasis.jpeg"
            ...
            <div class="p-4">
              ...
              <p class="text-sm text-gray-600">
                Eco-friendly resort in the desert
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="p-4">
              ...
              <p class="text-sm text-gray-600">
                Luxury hotel with stunning Nile views
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="p-4">
              ...
              <p class="text-sm text-gray-600">
                Costal city with historical sites
              </p>
            </div>
          </div>
          <div
          ...
          >
            <img
              src="../../public/profile/Costal-Breeze.jpg"
              alt="Coastal Breeze Apartments"
              class="w-full h-40 object-cover"
            />
            <div class="p-4">
              <h4 class="text-lg font-semibold text-gray-800 mb-1">
      ...
      <div v-else-if="activeTab === 'settings'">
          ...
          <div class="flex items-center justify-between mb-4">
            <div>
              ...
              <p class="text-sm text-gray-500">
                Receive email notifications for booking confirmations and
                updates.
              </p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div
                class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-yellow-500 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border after:border-gray-300 after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-yellow-400"
              ></div>
            </label>
          </div>
          <div class="flex items-center justify-between">
        ...
        <div>
          ...
          >
            <span class="font-medium"  @click="deleteAccount">Delete Account</span>
            <i class="fas fa-arrow-right text-gray-400"></i>
          </a>
...
function logout() {
  signOut(auth)
    .then(() => {
      router.push("/"); // يرجع المستخدم لصفحة تسجيل الدخول
    })
    .catch((error) => {
  ...
  if (user) {
    deleteUser(user)
      .then(() => {
        ...
        router.push("/login"); // يرجع المستخدم لصفحة تسجيل الدخول
      })
      .catch((error) => {
