      ...
      <div class="px-6 py-4 space-y-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl text-black  font-bold">Sobhy Kaber</h1>
          </div>
          <p class="text-lg text-gray-500 font-medium">Food</p>
        </div>

        <div class="grid grid-cols-4 gap-4">
          <img
            src="../../../../../public/Details/food/the-new-p.jpg"
            alt="Main Image"
            class="col-span-3 row-span-3 w-full h-[400px] object-cover rounded-xl shadow"
          />
          <div class="col-span-1 flex flex-col gap-4">
             <img
            src="../../../../../public/Details/food/OIP (39).webp"
            alt="Main Image"
class="w-full h-[120px] object-cover rounded-xl shadow"          />  <img
            src=   "../../../../../public/Details/food/OIP (40).webp"
            alt="Main Image"
class="w-full h-[120px] object-cover rounded-xl shadow"          />  <img
            src= "../../../../../public/Details/food/R (6).jpeg"
