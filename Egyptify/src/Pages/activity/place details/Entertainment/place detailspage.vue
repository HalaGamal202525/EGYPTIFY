      ...
      <div class="px-6 py-4 space-y-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl text-black  font-bold">Dream Park</h1>
          </div>
          <p class="text-lg text-gray-500 font-medium">Entertainment</p>
        </div>

        <div class="grid grid-cols-4 gap-4">
          <img
            src="../../../../../public/Details/entetainment/2b274056c46f2407b0204f7e680ebd00.jpg"
            alt="Main Image"
            class="col-span-3 row-span-3 w-full h-[400px] object-cover rounded-xl shadow"
          />
          <div class="col-span-1 flex flex-col gap-4">
             <img
            src="../../../../../public/Details/entetainment/OIP (19).webp"
            alt="Main Image"
class="w-full h-[120px] object-cover rounded-xl shadow"          />  <img
            src=   "../../../../../public/Details/entetainment/OIP (26).webp"
            alt="Main Image"
class="w-full h-[120px] object-cover rounded-xl shadow"          />  <img
            src= "../../../../../public/Details/entetainment/OIP (27).webp"
...
import data from '../../../../data/enterrtainment.json'
