<template>
  ...
  <section class="bg-[#fffdf6] text-gray-800 pb-20">
    <!-- Hero Section -->
    <div class="relative w-full h-[500px] overflow-hidden rounded-b-3xl shadow-md">
      <img
        :src="pkg.image"
    ...
    <div class="max-w-6xl mx-auto px-6 mt-12 grid md:grid-cols-2 gap-10">
      <!-- Left: Text -->
      <div class="space-y-6">
        <h2 class="text-3xl font-semibold text-[#ffc340]">{{ pkg.location }}</h2>
        <p class="text-lg text-gray-700 leading-relaxed">
          {{ pkg.fullDescription }}
        </p>

        <ul class="mt-6 space-y-2">
          <li><span class="font-semibold text-[#ffc340]"> Duration:</span> {{ pkg.duration }}</li>
          <li><span class="font-semibold text-[#ffc340]"> Price:</span> {{ pkg.price }}</li>
  ...
  <ol class="space-y-5 relative border-l-4 border-[#ffb703] pl-6 px-12 ">
    ...
    <div class="max-w-6xl mx-auto mt-20 px-6">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        >
          <p class="text-gray-600 italic">"Amazing experience, highly recommended!"</p>
