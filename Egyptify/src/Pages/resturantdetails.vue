...
<template>
  ...
  <div class="container mx-auto px-4 mt-28">
    ...
    <div v-if="restaurant" class="max-w-6xl mx-auto p-4 md:p-6 bg-white rounded-xl shadow-md">
  ...
  <div class="space-y-1 text-gray-700 text-sm">
    ...
    <p><i class="fa-solid fa-phone text-gray-600"></i> {{ restaurant.phone }}</p>
      ...
      <div class="flex flex-col lg:flex-row gap-6 mb-8 mt-20">
        ...
        <!-- Reservation Form -->
        <div class="flex-1 bg-gray-50 border border-gray-200 rounded-xl p-6 shadow-md">
          <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Reserve a Table</h2>
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col">
              <label class="text-gray-700 font-medium mb-1">Number of Guests</label>
              <input
                type="number"
                min="1"
                placeholder="2"
        ...
        >
          ...
          <div class="flex-1">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <div class="flex items-center text-yellow-500 text-sm mt-1 md:mt-0">
