      ...
      <div class="flex flex-col lg:flex-row gap-6 items-start">
        <div class="w-full lg:w-64 mt-0 bg-white p-4 rounded shadow space-y-4">
          <button
            ...
            class="lg:hidden bg-yellow-400 text-white font-bold px-4 py-2 rounded shadow w-full  cursor-pointer"
          >
            Filter
          </button>
...
>
              ...
              <div class="rounded-lg bg-white w-11/12 max-w-md p-6 shadow-lg mb-20">
                ...
                <div class="flex justify-end mt-4 space-x-2">
                  <button @click="closeOverlay" class="px-4 py-2 bg-white border border-[#ffc30] !text-[#ffc340]  cursor-pointer rounded hover:bg-yellow-400 hover:!text-yellow-900">Cancel</button>
                  <button @click="applyOverlayFilters" class="px-4 py-2 bg-yellow-400 text-black rounded  cursor-pointer hover:bg-yellow-500">Apply</button>
                </div>
              </div>
            </div>
          </transition>
