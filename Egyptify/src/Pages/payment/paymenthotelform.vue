...
const validateForm = () => {
  const { name, address, nationality, gender, idType, idNumber, phone, email } =
    formData.value;
  if (
    !name ||
    !address ||
  ...
  <div class="max-w-6xl mx-auto mt-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="space-y-6 lg:col-span-1">
      ...
      >
        ...
        <!-- ✅ تفاصيل الحجز -->
        <div
          v-if="hotelStore.bookingDetails.roomType"
        ...
        >
          ...
          <p class="font-semibold">
            Price/Night: {{ hotelStore.bookingDetails.price }} EGP
          </p>
          <img
        ...
        <p>Num of Nights: {{ hotelStore.totalNights }}</p>
