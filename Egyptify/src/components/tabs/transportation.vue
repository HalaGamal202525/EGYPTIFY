<template>
  <div class="max-w-screen-xl mx-auto px-2">
    ...
    <section class="grid grid-cols-1 md:grid-cols-4 gap-6 px-4 pb-10">
      <CardComponent
    ...
    <!-- Checkout Section -->
    <div v-if="bookingDetails" class="bg-white border mt-6 p-4 rounded-lg shadow">
      ...
      <p class="font-bold text-lg mt-2">Total: {{ selectedTransport.price * bookingDetails.people }} EGP</p>
    </div>
  </div>
</template>
